...
var grammarTestData = []struct {
	...
	{"@dec.func\ndef fn():\n    pass\n", "exec", "Module(body=[FunctionDef(name='fn', args=arguments(args=[], vararg=None, kwonlyargs=[], kw_defaults=[], kwarg=None, defaults=[]), body=[Pass()], decorator_list=[Attribute(value=Name(id='dec', ctx=Load()), attr='func', ctx=Load())], returns=None)])", nil, ""},
	{"@dec.func.func2\ndef fn():\n    pass\n", "exec", "Module(body=[FunctionDef(name='fn', args=arguments(args=[], vararg=None, kwonlyargs=[], kw_defaults=[], kwarg=None, defaults=[]), body=[Pass()], decorator_list=[Attribute(value=Attribute(value=Name(id='dec', ctx=Load()), attr='func', ctx=Load()), attr='func2', ctx=Load())], returns=None)])", nil, ""},
	{"@dec.func()\ndef fn():\n    pass\n", "exec", "Module(body=[FunctionDef(name='fn', args=arguments(args=[], vararg=None, kwonlyargs=[], kw_defaults=[], kwarg=None, defaults=[]), body=[Pass()], decorator_list=[Call(func=Attribute(value=Name(id='dec', ctx=Load()), attr='func', ctx=Load()), args=[], keywords=[], starargs=None, kwargs=None)], returns=None)])", nil, ""},
	{"@dec.func(a,b,c=d,*args,**kwargs)\ndef fn():\n    pass\n", "exec", "Module(body=[FunctionDef(name='fn', args=arguments(args=[], vararg=None, kwonlyargs=[], kw_defaults=[], kwarg=None, defaults=[]), body=[Pass()], decorator_list=[Call(func=Attribute(value=Name(id='dec', ctx=Load()), attr='func', ctx=Load()), args=[Name(id='a', ctx=Load()), Name(id='b', ctx=Load())], keywords=[keyword(arg='c', value=Name(id='d', ctx=Load()))], starargs=Name(id='args', ctx=Load()), kwargs=Name(id='kwargs', ctx=Load()))], returns=None)])", nil, ""},
	{"@dec1.func\n@dec2.func()\n@dec3.func(a)\ndef fn():\n    pass\n", "exec", "Module(body=[FunctionDef(name='fn', args=arguments(args=[], vararg=None, kwonlyargs=[], kw_defaults=[], kwarg=None, defaults=[]), body=[Pass()], decorator_list=[Attribute(value=Name(id='dec1', ctx=Load()), attr='func', ctx=Load()), Call(func=Attribute(value=Name(id='dec2', ctx=Load()), attr='func', ctx=Load()), args=[], keywords=[], starargs=None, kwargs=None), Call(func=Attribute(value=Name(id='dec3', ctx=Load()), attr='func', ctx=Load()), args=[Name(id='a', ctx=Load())], keywords=[], starargs=None, kwargs=None)], returns=None)])", nil, ""},
